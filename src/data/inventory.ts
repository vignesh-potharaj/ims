...
export const mockInventory: Product[] = [
  // --- FURNITURE & DECOR (Complex Geometry) ---
  { id: "p1", name: "Eames Lounge Chair", sku: "FUR-EAM-L01", category: "A", quantity: 5, reorderPoint: 2, unitPrice: 5495.00, warehouse: "Mumbai Central" },
  ...
  { id: "p4", name: "Velvet Sofa - 3 Seater", sku: "FUR-VEL-S04", category: "A", quantity: 8, reorderPoint: 3, unitPrice: 1899.00, warehouse: "Bengaluru South" },
  ...
  { id: "p6", name: "Marble Coffee Table", sku: "FUR-MAR-C06", category: "B", quantity: 15, reorderPoint: 5, unitPrice: 650.00, warehouse: "Delhi North" },
  ...
  { id: "p9", name: "Outdoor Patio Set", sku: "FUR-OUT-P09", category: "A", quantity: 10, reorderPoint: 4, unitPrice: 2200.00, warehouse: "Mumbai Central" },
  ...
  // --- SPORTS & OUTDOOR (Spherical & Aerodynamic) ---
  ...
  { id: "p13", name: "Carbon Fiber Road Bike", sku: "SPO-CAR-R13", category: "A", quantity: 6, reorderPoint: 2, unitPrice: 3200.00, warehouse: "Hyderabad Hub" },
  ...
  { id: "p16", name: "Camping Tent - 4 Person", sku: "SPO-CAM-T16", category: "B", quantity: 25, reorderPoint: 10, unitPrice: 210.00, warehouse: "Mumbai Central" },
  ...
  { id: "p18", name: "Electric Scooter", sku: "SPO-ELE-S18", category: "A", quantity: 15, reorderPoint: 5, unitPrice: 850.00, warehouse: "Bengaluru South" },
  ...
  // --- TOYS & MODELS (Detailed Articulation) ---
  { id: "p21", name: "LEGO Star Destroyer", sku: "TOY-LEG-S21", category: "A", quantity: 20, reorderPoint: 5, unitPrice: 699.00, warehouse: "Hyderabad Hub" },
  ...
  { id: "p26", name: "Telescope - Beginner", sku: "TOY-TEL-B26", category: "B", quantity: 35, reorderPoint: 8, unitPrice: 220.00, warehouse: "Bengaluru South" },
  ...
  // --- ELECTRONICS & MOBILES (Sleek Surfaces) ---
  { id: "p31", name: "iPhone 15 Pro", sku: "MOB-APL-P31", category: "A", quantity: 100, reorderPoint: 20, unitPrice: 999.00, warehouse: "Mumbai Central" },
  { id: "p32", name: "Pixel 8 Pro", sku: "MOB-GOO-P32", category: "A", quantity: 80, reorderPoint: 15, unitPrice: 899.00, warehouse: "Delhi North" },
  { id: "p33", name: "Galaxy S24 Ultra", sku: "MOB-SAM-S33", category: "A", quantity: 90, reorderPoint: 15, unitPrice: 1199.00, warehouse: "Hyderabad Hub" },
  ...
  { id: "p38", name: "Gaming Console V5", sku: "GAM-CON-V38", category: "A", quantity: 60, reorderPoint: 20, unitPrice: 499.00, warehouse: "Bengaluru South" },
  { id: "p39", name: "VR Headset - Elite", sku: "GAM-VRH-E39", category: "A", quantity: 25, reorderPoint: 5, unitPrice: 999.00, warehouse: "Mumbai Central" },
  ...
  // --- KITCHEN & APPLIANCES (Technical Shapes) ---
  { id: "p41", name: "Espresso Machine", sku: "KIT-ESP-M41", category: "A", quantity: 20, reorderPoint: 5, unitPrice: 850.00, warehouse: "Hyderabad Hub" },
